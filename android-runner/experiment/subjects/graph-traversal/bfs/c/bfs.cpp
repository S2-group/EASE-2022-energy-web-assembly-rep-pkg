...
//if no thread changes this value then the loop stops
    ...
    float init_time = get_interval_by_sec(&sw2)
    ...
    fprintf(stdout, "{\"options\": \"%d\", \"init_time\": %f \"time\": %f, \"status\": %d}\n", no_of_nodes, init_time, get_interval_by_sec(&sw1), 1);
}
